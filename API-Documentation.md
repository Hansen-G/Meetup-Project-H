...
* Request
  * Method: PUT
  * URL: /api/groups/:groupId/members/change
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /api/events/new/groups/:groupId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /api/groups/:groupId/new/image
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /api/events/:eventId/new/image
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * URL: /api/events?page=&size=&name=&type=&startDate=
  * Query Parameters
